...
public class CustomDialog extends JDialog implements ActionListener, PropertyChangeListener {
	...
	private String SortDescending = "Сортирай по низходящ ред";
		...
		if (isVisible() && (evt.getSource() == optionPane)
			...
			if (textField.getText() != null && !textField.getText().isEmpty()) {
				...
				try {
					...
					JOptionPane.showMessageDialog(CustomDialog.this, "Въвели сте: " + typedText + " вместо число!", "Грешка", JOptionPane.ERROR_MESSAGE);
					typedText = null;
